...
function HotelDetails() {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-1/4 w-96 h-96 -z-10 bg-blue-200/30 rounded-full blur-3xl" />
      <div className="fixed top-1/3 right-0 w-96 h-96 -z-10 bg-violet-200/30 rounded-full blur-3xl" />

      <div className="min-h-screen" style={{ paddingTop: navHeight }}>
        ...
        <div className="pt-4 px-4 sm:px-6 max-w-6xl mx-auto">
          <button
            ...
            className="group inline-flex items-center gap-1.5 text-sm font-medium text-gray-500 hover:text-blue-600 transition-all duration-300"
          >
            <svg
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-4">
          <div
            className="
              ...
              rounded-2xl shadow-lg shadow-blue-100/50 border border-white/60
              p-5 sm:p-7 flex flex-col lg:flex-row gap-6
              animate-[fadeInUp_0.6s_ease-out]
              transition-shadow duration-500 hover:shadow-xl hover:shadow-blue-200/40
            "
          >
            ...
            <div className="w-full lg:w-2/5 flex flex-col">
              ...
              <p className="mt-1.5 text-gray-600">{hotel?.address}</p>
              <p className="text-sm text-gray-400">{hotel?.district}, {hotel?.state}</p>

              <div className="mt-3 flex items-center gap-2">
                <span className="inline-flex items-center gap-1 bg-gradient-to-r from-emerald-50 to-emerald-100 text-emerald-700 text-sm font-semibold px-2.5 py-1 rounded-md shadow-sm">
              ...
              <div className="mt-4 pt-4 border-t border-blue-100/70">
                <p className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-600 to-violet-600 bg-clip-text text-transparent">
                  ₹{hotel?.pricePerNight}
                </p>
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {hotel.amenities.map((a, i) => (
                      <span
                        key={i}
                        className="
                          bg-white/80 text-gray-700 px-3 py-1.5 rounded-full text-sm font-medium
                          border border-gray-200/80 shadow-sm
                          transition-all duration-300 ease-out
                          hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200 hover:scale-105 hover:shadow-md
                        "
                      >
                        {a}
                      </span>
          ...
          <div
            className="
              bg-white/70 backdrop-blur-xl backdrop-saturate-150
              rounded-2xl shadow-lg shadow-violet-100/50 border border-white/60
              mt-6 p-5 sm:p-7 flex flex-col lg:flex-row gap-6
              animate-[fadeInUp_0.6s_ease-out_0.1s]
              transition-shadow duration-500 hover:shadow-xl hover:shadow-violet-200/40
            "
          >
            ...
            <div className="w-full lg:w-2/5 flex flex-col">
              ...
              <div className="relative isolate z-0 overflow-hidden rounded-xl border border-gray-200 shadow-inner h-72 lg:h-auto lg:flex-1 ring-1 ring-white/50">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-6 pb-16">
          <div
            className="
              bg-white/70 backdrop-blur-xl backdrop-saturate-150
              rounded-2xl shadow-lg shadow-emerald-100/50 border border-white/60
              p-5 sm:p-7
              animate-[fadeInUp_0.6s_ease-out_0.2s]
              transition-shadow duration-500 hover:shadow-xl hover:shadow-emerald-200/40
            "
          >
